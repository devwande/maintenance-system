...
//   const [dormitory, setDormitory] = useState<string>()
//   const [password, setPassword] = useState<string>()
//   const [confirmPassword, setConfirmPassword] = useState<string>()

//   const handleLogin = async (e: React.FormEvent) => {
//     e.preventDefault()
//     axios.post('http://localhost:3001/students', {regNumber, password})
...
//     setTimeout(() => {
//       setIsLoading(false)
//       navigate("/studentdashboard") a
//     }, 1500)
//   }

//   const handleRegister = async (e: React.FormEvent) => {
//     e.preventDefault()
//     axios.post('http://localhost:3001/students', {name, regNumber, email, dormitory, password, confirmPassword})
//       .then((response) => console.log(response.data))
//       .catch(err => console.log(err))
//     setIsLoading(true)
...
//                 Registration Number
//               </label>
//               <input id="loginRegNumber" placeholder="e.g. 2100599" onChange={(e) => setRegNumber(e.target.value)} required className="border border-gray-300 w-full px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-black" />
//             </div>
...
//                 Password
//               </label>
//               <input id="loginPassword" type="password" onChange={(e) => setPassword(e.target.value)} required className="border border-gray-300 w-full px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-black" />
//             </div>
